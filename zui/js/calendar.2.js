...
jQuery.fn.extend({
    calendar: function(c) {
        function r() {
            $("#" + c.controlId).find(".zui-caltab-day a").mouseup(function() {
                ...
                if ($(this).hasClass("prevD")) {
                    ...
                    var b = c.speed;
                    c.speed = 0;
                    $("#" + c.controlId).find(".zui-prev-month").triggerHandler("mouseup");
                    c.speed = b
                    ...
                    b = c.speed;
                    c.speed = 0;
                    $("#" + c.controlId).find(".zui-next-month").triggerHandler("mouseup");
                    c.speed = b
                }
                var d = $(this).text();
                ...
                $("#" + c.controlId + " .zui-caltab-day a:contains('" + d + "')").each(function() {
        ...
        function u() {
            $("#" + c.controlId).find(".zui-caltab-month a").mouseup(function() {
        ...
        function v() {
            $("#" + c.controlId).find(".zui-caltab-year a").mouseup(function() {
        ...
        function B(a) {
            var b = $("#" + c.controlId).find(".zui-calendar-reserve"),
            d = $("#" + c.controlId).find(".zui-calendar-enabled");
            b.stop();
            d.stop();
        ...
        q = today.getDate(),
        k = "";
        k += "<div id='" + c.controlId + "'class='zui-calendar'>";
        ...
        $("body").append(k);
        r();
        $("#" + c.controlId).find(".zui-prev-month").mouseup(function() {
            if ($("#" + c.controlId).find(".zui-calendar-enabled > .zui-caltab-day").length > 0) {
                ...
                r()
            } else if ($("#" + c.controlId).find(".zui-calendar-enabled > .zui-caltab-month").length > 0) {
            ...
            } else if ($("#" + c.controlId).find(".zui-calendar-enabled > .zui-caltab-year").length > 0) {
        ...
        $("#" + c.controlId).find(".zui-next-month").mouseup(function() {
            if ($("#" + c.controlId).find(".zui-calendar-enabled > .zui-caltab-day").length > 0) {
                var a = $("#" + c.controlId).find(".currentYear"),
                b = $("#" + c.controlId).find(".currentMonth"),
        ...
        $("#" + c.controlId).find(".zui-month-txt").mouseup(function() {
            if (! ($("#" + c.controlId).find(".zui-calendar-enabled > .zui-caltab-month").length > 0)) {
                var a = z(Number($("#" + c.controlId).find(".currentYear").text()));
                E(a);
                u()
            }
        });
        $("#" + c.controlId).find(".zui-year-txt").mouseup(function() {
            if (! ($("#" + c.controlId).find(".zui-calendar-enabled > .zui-caltab-year").length > 0)) {
